...
export interface Hydra extends EventEmitter {
     ...
     */
    init(config: any | string, testMode: boolean);
...
export interface HydraExpress {
     ...
     */
    init(config, version: string, registerRoutesCallback: Function, registerMiddlewareCallback?: Function): Promise<any>;
     ...
     * @return {undefined}
     */
    registerRoutes(routes: { [key: string]: string }): undefined;
     ...
     * @return {undefined}
     */
    start(resolve, _reject): undefined;
